...
def get_coordinate_value(coordinate_name):
    while (1):
        ...
        float_coordinate_value = check_coordinate_value(coordinate_value)
        if float_coordinate_value is None:
            print("{} введена неверно. Повторите ввод!".format(
                coordinate_name))
            continue
